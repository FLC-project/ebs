...
The "bs" and "bsp" tools are user-friendly and self-documented: run them in the browser and have a look at the instructions in the interface page; all commands and data can be input into dialog boxes.
